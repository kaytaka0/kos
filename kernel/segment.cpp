...
namespace {
    // gdt[0]: null
    // gdt[1]: コードセグメントディスクリプタ
    // gdt[2]: データセグメントディスクリプタ
...
void SetCodeSegment(SegmentDescriptor& desc,
    ...
    desc.bits.limit_low = limit & 0xffu;
    desc.bits.limit_low = (limit >> 16) & 0xfu;
    ...
    desc.bits.default_operation_size = 0; // should be - when long_mode == 1
